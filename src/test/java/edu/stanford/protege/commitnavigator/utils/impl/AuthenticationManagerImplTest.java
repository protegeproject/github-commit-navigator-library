...
class AuthenticationManagerImplTest {
  ...
  void testValidateAuthentication_ValidPersonalAccessToken() throws AuthenticationException {
    var config = AuthenticationConfig.personalAccessToken("valid-token").build();
  ...
  void testValidateAuthentication_EmptyToken() {
    var config = AuthenticationConfig.personalAccessToken("").build();
  ...
  void testValidateAuthentication_NullToken() {
    var config = AuthenticationConfig.personalAccessToken(null).build();
  ...
  void testValidateAuthentication_UsernamePassword() throws AuthenticationException {
    var config = AuthenticationConfig.usernamePassword("testuser", "testpass").build();
  ...
  void testValidateAuthentication_EmptyUsername() {
    var config = AuthenticationConfig.usernamePassword("", "testpass").build();
  ...
  void testValidateAuthentication_EmptyPassword() {
    var config = AuthenticationConfig.usernamePassword("testuser", "").build();
  ...
  void testGetCredentialsProvider_PersonalAccessToken() throws AuthenticationException {
    var config = AuthenticationConfig.personalAccessToken("test-token").build();
  ...
  void testGetCredentialsProvider_OAuth() throws AuthenticationException {
    var config = AuthenticationConfig.oauth("oauth-token").build();
  ...
  void testGetCredentialsProvider_SshKey() {
    var config = AuthenticationConfig.sshKey("/path/to/key").build();
