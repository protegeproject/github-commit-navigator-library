 ...
 * including Personal Access Tokens, OAuth tokens, username/password combinations, and SSH keys. The
 * configuration is immutable and uses the builder pattern for construction.
 *
 * <p>Usage examples:
 *
 * <pre>{@code
