 ...
 * 
 * <p>This interface provides methods to move forward and backward through commit history,
 * with optional checkout functionality. The navigation respects file filters and branch
 * configuration specified in the repository navigator configuration.</p>
 * 
 * <p>Usage example:</p>
 * <pre>
 * {@code
