 ...
 *
 * <p>This exception is thrown when there are issues with authentication credentials,
 * invalid tokens, network connectivity problems during authentication, or when
 * the authentication method is not supported.</p>
 *
 * @since 1.0.0
 */
