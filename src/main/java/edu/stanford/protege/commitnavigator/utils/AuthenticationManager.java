 ...
 *
 * <p>This interface provides methods to authenticate with GitHub using various authentication
 * methods including Personal Access Tokens, OAuth tokens, username/password combinations, and SSH
 * keys. It also handles credential provider creation for Git operations.
 *
 * @since 1.0.0
 */
public interface AuthenticationManager {
   ...
   */
  CredentialsProvider getCredentialsProvider(AuthenticationConfig config)
   ...
   * @throws AuthenticationException if the authentication configuration is invalid, credentials are
