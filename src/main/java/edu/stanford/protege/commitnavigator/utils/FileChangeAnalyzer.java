 ...
 *
 * <p>This interface provides methods to analyze commits and determine which files were modified,
 * added, or deleted. It supports file filtering based on glob patterns to focus on specific types
...
public interface FileChangeAnalyzer {
   ...
   */
  boolean hasFileChanges(Repository repository, RevCommit commit, List<String> fileFilters)
